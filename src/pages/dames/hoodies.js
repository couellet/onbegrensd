...
const DamesHoodies = ({ data }) => (
  <Layout>
    <StyledH1>Dames hoodies</StyledH1>
...
export default DamesHoodies

export const damesHoodiesQuery = graphql`
  query {
    allMarkdownRemark(
      filter: { frontmatter: { tags: { in: "hoodie-dames" } } }
    ) {
      edges {
        node {
          id
